...
public class VAddAccount extends Controller{
    public void index(View v){
        v.getContentPane().removeAll();
        v.setJMenuBar(null);
        v.setTitle("Add Account");
        v.setSize(270, 220);
        ...
        addButton.setBounds(130,125,130,40);//165
        ...
        addButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                v.popUpOk((String)self("CAddAccount","add",false,branchField.getText(),balanceField.getText()));
            }
        });
