...
import  MVC.Models.*;
import  MVC.Views.*;
public class CSearchAccounts extends Controller{
    public CSearchAccounts(){
        Terminal.writeLine("from CSearchAccounts");
    }
    public void index() {
        view("VSearchAccounts",false);
    }
    ...
    public String[][] search(
        ...
        return (String [][])
                ((MAccounts)model("MAccounts")).search(
